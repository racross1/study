...
// For each current node, calculate the tentative distance to each of its unvisited neighbor nodes. 

// Add the distance from the current node to the neighbor node to the distance from the starting node.
